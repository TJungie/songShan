...
@interface JJSettingViewController ()
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UIAlertController * alert = [UIAlertController alertControllerWithTitle:@"警告" message:@"将要清除缓存数据" preferredStyle:UIAlertControllerStyleAlert];
    ...
    UIAlertAction *okAct = [UIAlertAction actionWithTitle:@"确定" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        ...
        [[JJDataBase ShareDataBase].db executeUpdate:@"delete from shareStatus"];
    }];
