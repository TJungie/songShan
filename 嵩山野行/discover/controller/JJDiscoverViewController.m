...
#import "JJConversationController.h"
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.textLabel.text = [NSString stringWithFormat:@"%ld--哈哈哈",(long)indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JJConversationController *chat = [[JJConversationController alloc] init];
    chat.title = @"聊天";
    chat.conversationType = ConversationType_PRIVATE;
    chat.targetId = @"20160507songshanyexing";
